...
def get_cmdclass():
    ...
    class build_torsion_library(install):
        def run(self):
            ...
            torsion_library_working_dir_name = os.path.abspath('./')
            torsion_library_file_name = os.path.join(torsion_library_working_dir_name, 'torsion_library.pkl')
            torsion_library_builder = TorsionLibraryBuilder(torsion_library_working_dir_name)
